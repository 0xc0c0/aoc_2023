...
def test_parse_input(test_data):
    ...
    assert function(calibration_lines[0]) == 0
    assert function(calibration_lines[3]) == 0
    
def test_parse_input_2(test_data2):
    calibration_lines = parse_data(test_data2)
    assert function2(calibration_lines[0]) == 0
    assert function2(calibration_lines[3]) == 0
