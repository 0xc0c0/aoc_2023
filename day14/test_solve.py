...
import os
import pytest
from .solve import parse_data, get_load_after_north_tilt, get_load_after_spin_cycles
...
def test_all(test_data):
    ...
    """
    data = parse_data(test_data)
    assert get_load_after_north_tilt(data) == 136
    assert get_load_after_spin_cycles(data) == 64
